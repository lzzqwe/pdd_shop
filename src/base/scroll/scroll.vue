  ...
  export default {
    ...
    methods: {
      _initScroll() {
        ...
        if(!this.scroll){
          //this.$refs.scroll.style.height=(window.outerHeight?window.outerHeight:document.documentElement.clientHeight)-88+'px'
      ...
      enable(){this.scroll&&this.scroll.enable()},
      disable(){this.scroll&&this.scroll.disable()},
